...
class _TasklistState extends State<Tasklist> {
  ...
  @override
  void initState() {   //initstate old iicn  bu liste yalnızca bir kere tanımlanıyor sürekli sıfırlanmıyor yani bi kere calısır
    super.initState();
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return Card(
                ...
                child: TextButton(
                  onPressed: (){
                   Navigator.push(
                    context, MaterialPageRoute(builder: (context)=> Edittask(taskmodel: task)));
                  }
                  child: ListTile(
                    leading: Checkbox(
